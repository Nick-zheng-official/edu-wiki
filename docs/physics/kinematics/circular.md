...
![](../images/最短时间渡河.png){ width = 300px }
![](../images/最短位移渡河.png){ width = 300px }
![](../images/最短位移渡河2.png){ width = 300px }
...
![](../images/接触面1.png){ width = 300px }
![](../images/接触面2.png){ width = 300px }
...
![](../images/同面不同角.png){ width = 300px }

推导可得 $\omega$ 与 $Lcos\alpha = H$ 成反比, $H$ 为悬挂点距离转动平面的高度, 故相同面内 $\omega$ 相同. 即可比较其他物理量.

![](../images/临界1.png){ width = 300px }
![](../images/临界2.png){ width = 300px }
