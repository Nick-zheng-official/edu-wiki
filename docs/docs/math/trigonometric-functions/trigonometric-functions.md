...
<figure style="display: flex; justify-content: center; flex-direction: column; align-items: center;">
  <img src="../images/正弦函数.png" width="500" />
  <figcaption>正弦函数</figcaption>
</figure>
...
<figure style="display: flex; justify-content: center; flex-direction: column; align-items: center;">
  <img src="../images/余弦函数.png" width="500" />
  <figcaption>余弦函数</figcaption>
</figure>

余弦函数定义域为 $\mathbb{R}$ , 值域 $[-1, 1]$ , 对称轴 $x = k\pi$ , 对称中心 $(\frac{\pi}{2} + k\pi, 0) , k \in \mathbb{Z}$ , $T = 2\pi$ . 余弦函数是偶函数.

<figure style="display: flex; justify-content: center; flex-direction: column; align-items: center;">
  <img src="../images/正切函数.png" width="500" />
  <figcaption>正切函数</figcaption>
</figure>
