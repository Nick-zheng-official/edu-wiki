...
![](../images/三角恒等变换推导.png){ width=500px }

由此图可以推导出以下公式:

![](../images/两角和差公式.png){ width=500px }
...
![](../images/积化和差.png){ width=500px }

使用频率低, 难记忆, 且推导方便, 故建议现场推导.

将积化和差换元可得到和积化差公式:

![](../images/和差化积.png){ width=500px }
