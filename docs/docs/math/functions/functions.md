...
![](../images/类二次函数.png){ width=500px }
![](../images/类三次函数.png){ width=500px }
...
![](../images/零点存在定理.png){ width=500px }

## 函数不等式

![](../images/函数不等式.png){ width=500px }
