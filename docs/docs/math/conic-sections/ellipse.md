...
<div style="display: flex; justify-content: center;"><img src="../images/椭圆基础.png" width="500" /></div>  
<div style="display: flex; justify-content: center;"><img src="../images/椭圆基础2.png" width="500" /></div>  
...
<div style="display: flex; justify-content: center;"><img src="../images/双曲线.png" width="500" /></div>
...
|特殊图形      |如图        | <figure style="display: flex; justify-content: center; flex-direction: column; align-items: center;">
  <img src="../images/双曲线特殊图形.png" width="500" />
  <figcaption>焦点到渐近线距离为 $b$</figcaption>
</figure>        |
...
<div style="display: flex; justify-content: center;"><img src="../images/双曲线基础.png" width="500" /></div>
...
<div style="display: flex; justify-content: center;"><img src="../images/抛物线.png" width="500" /></div>
...
<div style="display: flex; justify-content: center;"><img src="../images/阿基米德三角形.png" width="500" /></div>
...
11. 两弦长/向量模长乘积(求最值)可以转化成数量积  <div style="display: flex; justify-content: center;"><img src="../images/模长乘积.png" width="500" /></div>  $\vec{a} \cdot \vec{b} = \vec{a} \cdot \vec{c} = -|\vec{a}||\vec{c}|$
12. 锐角/钝角/直角判断用数量积
13. 求角度可以
    - 数量积
    - 找直角三角形
...
<div style="display: flex; justify-content: center;"><img src="../images/对称斜率和为零.png" width="500" /></div>
