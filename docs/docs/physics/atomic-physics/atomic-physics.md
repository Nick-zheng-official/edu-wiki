...
![](../images/光电效应图像.png){ width=300px }

图像与横轴交点为遏止电压, 最大光电流处为饱和光电流.

![](../images/光电效应图像表达式.png){ width=300px }
