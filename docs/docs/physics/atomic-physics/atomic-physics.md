...
![img](../images/辐射图像.png){ width=300px }
...
![img](../images/光电实验.png){ width=400px }
...
![](../images/光电效应图像.png){ width=500px }

图像与横轴交点为遏止电压, 最大光电流处为饱和光电流.

![](../images/光电效应图像表达式.png){ width=500px }
...
![img](../images/平均质量比较.png){ width=400px }
