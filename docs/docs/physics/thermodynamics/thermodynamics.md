...
![](../images/表面张力.png){ width=500px }

![](../images/肥皂泡.png){ width=500px }
...
![](../images/活塞受力.png){ width=500px }

当然也不一定要分析活塞, 选择受力更少的物体分析即可, 如下图可以分析容器 $M$ .

![](../images/分析容器.png){ width=500px }
...
![不是两气挤压](../images/非两气挤压.png){ width=500px }
