...
![img](../images/布朗运动.png){ width=300px }
...
![img](../images/分子间作用力.png){ width=300px }
...
![img](../images/分子动能.png){ width=300px }
...
![img](../images/各向异性.png){ width=400px }
...
![img](../images/表面张力.png){ width=300px }

![img](../images/肥皂泡.png){ width=300px }
...
![img](../images/不浸润.png){ width=400px }
...
![img](../images/压强作图.png){ width=300px }
...
![img](../images/活塞受力.png){ width=300px }

当然也不一定要分析活塞, 选择受力更少的物体分析即可, 如下图可以分析容器 $M$ .

![img](../images/分析容器.png){ width=300px }
...
![不是两气挤压](../images/非两气挤压.png){ width=300px }
...
![img](../images/移动试管.png){ width=200px }
...
![img](../images/U形管移动.png){ width=300px }
...
![img](../images/内能画图.png){ width=300px }
