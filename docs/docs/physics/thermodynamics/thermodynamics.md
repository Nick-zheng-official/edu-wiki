...
<div style="display: flex; justify-content: center;"><img src="../images/布朗运动.png" width="500" /></div>
...
<div style="display: flex; justify-content: center;"><img src="../images/分子间作用力.png" width="500" /></div>
...
<div style="display: flex; justify-content: center;"><img src="../images/分子势能.png" width="500" /></div>

可以发现分子势能在 $r_0$ 处取得极小值(负数), 同时分子力也最小(零). 由此我们扩展 $211$ 方法: 在下方打一个勾表示分子势能. $211$ 方法实际上就是一个简化的图像, 在没有图像时比较简便.

<div style="display: flex; justify-content: center;"><img src="../images/211.png" width="500" /></div>
...
<div style="display: flex; justify-content: center;"><img src="../images/分子动能.png" width="500" /></div>
...
<div style="display: flex; justify-content: center;"><img src="../images/各向异性.png" width="500" /></div>
...
<div style="display: flex; justify-content: center;"><img src="../images/表面张力.png" width="500" /></div>

<div style="display: flex; justify-content: center;"><img src="../images/肥皂泡.png" width="500" /></div>
...
<div style="display: flex; justify-content: center;"><img src="../images/浸润.png" width="500" /></div>

更宏观地若液体分子更易被固体分子吸引则应增大接触固体的面积, 呈现凹液面, 为浸润; 凸液面同理. 浸润或不浸润的程度与固体和液体均有关.

<div style="display: flex; justify-content: center;"><img src="../images/毛细现象.png" width="500" /></div>
...
<div style="display: flex; justify-content: center;"><img src="../images/不浸润.png" width="500" /></div>
...
<div style="display: flex; justify-content: center;"><img src="../images/液晶.png" width="500" /></div>
...
<div style="display: flex; justify-content: center;"><img src="../images/压强作图.png" width="500" /></div>
...
<div style="display: flex; justify-content: center;"><img src="../images/活塞受力.png" width="500" /></div>

当然也不一定要分析活塞, 选择受力更少的物体分析即可, 如下图可以分析容器 $M$ .

<div style="display: flex; justify-content: center;"><img src="../images/分析容器.png" width="500" /></div>
...
<div style="display: flex; justify-content: center;"><img src="../images/移动试管.png" width="500" /></div>
...
<div style="display: flex; justify-content: center;"><img src="../images/加液.png" width="500" /></div>
...
<div style="display: flex; justify-content: center;"><img src="../images/玻意耳定律.png" width="500" /></div>

如图为根据玻意耳定律得到的图像, 前者为反比例函数, 后者为正比例函数.

<div style="display: flex; justify-content: center;"><img src="../images/查理定律.png" width="500" /></div>

如图为根据查理定律得到的图像.

<div style="display: flex; justify-content: center;"><img src="../images/盖吕萨克定律.png" width="500" /></div>
...
<div style="display: flex; justify-content: center;"><img src="../images/爬坡.png" width="500" /></div>
...
<div style="display: flex; justify-content: center;"><img src="../images/U形管移动.png" width="500" /></div>
...
<div style="display: flex; justify-content: center;"><img src="../images/内能画图.png" width="500" /></div>
