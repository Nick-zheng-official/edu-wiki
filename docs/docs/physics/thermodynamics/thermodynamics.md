...
![img](../images/表面张力.png){ width=200px }
...
![img](../images/不浸润.png){ width=300px }
...
![img](../images/压强作图.png){ width=100px }
...
![img](../images/活塞受力.png){ width=200px }

当然也不一定要分析活塞, 选择受力更少的物体分析即可, 如下图可以分析容器 $M$ .

![img](../images/分析容器.png){ width=200px }
...
![img](../images/移动试管.png){ width=100px }
...
![img](../images/内能画图.png){ width=200px }
