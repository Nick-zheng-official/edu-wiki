...
定义: 生态系统中能量的 __输入, 传递, 转化, 散失__ 的过程成为生态系统的能量流动.  
同化:  是指生物体将外界的物质（主要是从食物中获取的营养物质）转化并合成为自身生物质（即自身体内组织）的过程.  
过程:
1. 能量输入
   - 来源: 太阳能(也可以是人工/化能合成)
...
概念:  组成生物体的 $C, H, O, N, P, S$ 等 __元素__ , 都不断地进行着从 __非生物环境__ 到 __生物群落__ , 又从生物群落到非生物环境的过程.  
特点: 
1. 全球性, 因此又叫生物地球化学循环
2. 循环性, 物质可以被生物群落反复利用
