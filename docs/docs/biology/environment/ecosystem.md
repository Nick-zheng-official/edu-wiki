...
定义: 生态系统中能量的 **输入, 传递, 转化, 散失** 的过程成为生态系统的能量流动.  
...
概念: 组成生物体的 $C, H, O, N, P, S$ 等 **元素** , 都不断地进行着从 **非生物环境** 到 **生物群落** , 又从生物群落到非生物环境的过程.  
特点:
...
![碳循环](../images/碳循环.png){ width=500px }  
如何实现碳中和(读图):
...
![稳定性1](../images/稳定性1.png){ width=500px }

![稳定性2](../images/稳定性2.png){ width=500px }
