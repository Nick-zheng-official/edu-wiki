...
A：不知道你在学习的时候，面对庞大的知识体系，有没有感到过迷茫无助的时候？**EDU Wiki** 想要做的事情可能类似于「让更多竞赛资源不充裕的同学能方便地接触到训练资源」．当然这么表述也不完全，做 Wiki 的动机可能也很纯粹，只是简单地想要对 **EDU** 的发展做出一点点微小的贡献吧．
...
Q: 为什么不允许使用 **AIGC** (AI 生成的内容)?

---

Q: AI 现在太好用辣! 你们为什么还要做这样的 Wiki?
...
在 AI 快速发展的今天, 你们为什么要创建 EDU Wiki? 
...
高中生呆在学校的时间比在家还长, 你们做这个 Wiki 真的有人看有人维护吗?
...
**EDU Wiki** 中不提供任何由 AI 生成的文章, 至少文章质量不低于 AI 生成的文章, 因为我们没有办法监督协作者不使用 AI 生成的文章, 但我们可以对文章质量进行保证. 

---

能不能在 Wiki 页面下增加评论系统? 我想和大家交流! 
